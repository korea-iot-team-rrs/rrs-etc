...
CREATE TABLE `RESERVATION_LISTS` (
	`RESERVATION_LIST_ID` bigint unsigned PRIMARY KEY AUTO_INCREMENT COMMENT '예약목록ID 기본키',
	`ID` bigint unsigned NOT NULL COMMENT '유저ID 기본키',
...
CREATE TABLE `CERTIFICATION_NUMBERS` (
	`CERTIFICATION_NUMBER_ID` bigint NOT NULL,
...
CREATE TABLE `ANNOUNCEMENT_LIST` (
	`ANNOUNCEMENT_LIST_ID` bigint unsigned PRIMARY KEY AUTO_INCREMENT COMMENT '공지사항ID기본키',
