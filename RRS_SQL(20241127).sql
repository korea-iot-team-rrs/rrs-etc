...
CREATE TABLE `CUSTOMER_SUPPORTS` (
	...
	`CUSTOMER_SUPPORT_CONTENT` VARCHAR(255) NOT NULL COMMENT '내용',
...
CREATE TABLE `HEALTH_RECORDS` (
	...
	`HEALTH_RECORD_MEDICAL_RECORD` VARCHAR(255) NOT NULL COMMENT '진료 내역',
...
CREATE TABLE `WALKING_RECORDS` (
	...
	`WALKING_RECORD_WALKING_TIME` int NOT NULL COMMENT '산책 시간',
...
DESCRIBE WALKING_RECORDS;
DESCRIBE WALKING_RECORD_ATTACHMENTS;
DESCRIBE PET_PROFILES;
